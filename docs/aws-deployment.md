...
- [x] Faster deploys: Express canary bake tweak (~3 min rolls); ops in [`runbook-deploy-compute.md`](runbook-deploy-compute.md) §2b; history in [`plan-fast-app-deploys.md`](plan-fast-app-deploys.md)
